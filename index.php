				...
				<div class="col-md-6 wthree-bottom-grid">
					<div class="w3-agileits-bottom-left">
						<div class="w3-agileits-bottom-left-text">
							...
							<p>With Respect and Decipline. we are here to make your day special by our service.</p>
						</div>
					</div>
				</div>
				<div class="col-md-6 wthree-bottom-grid">
					<div class="w3-agileits-bottom-left w3-agileits-bottom-right">
						<div class="w3-agileits-bottom-left-text">
							<h3>LET THE EXPERTS RUN YOUR SERVICE</h3>
							<p>As Experts we are here to handle everything with joy and polite manner.</p>
						</div>
					</div>
				</div>
				<div class="clearfix"> </div>
