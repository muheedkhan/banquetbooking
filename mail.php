			...
			<div class="agile-contact-form">
				<div class="col-md-6 contact-form-left">
					<div class="w3layouts-contact-form-top">
						<h3>Get in touch</h3>
						<p>We are here to help you with any kind of problem. if you have any quaries you can take help from our services we will help you until it gets solved.<BR> 
							THANK YOU
						</p>
					</div>
